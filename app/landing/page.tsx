  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gray-900 text-white font-sans">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900/60 via-purple-900/40 to-pink-900/60"></div>
      </div>
      ...
      <header className="absolute top-0 left-0 right-0 z-10 p-6 flex justify-between items-center backdrop-blur-sm bg-black/10">
        <div className="flex items-center space-x-3 group cursor-pointer">
          ...
          />
          <span className="text-3xl font-bold bg-gradient-to-r from-white via-pink-200 to-purple-200 bg-clip-text text-transparent">
            sui tinder
          </span>
        </div>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
        <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold leading-tight tracking-tight mb-8">
          ...
          <span className="text-2xl md:text-3xl lg:text-4xl align-super text-pink-400 animate-bounce">®</span>
        </h1>

        <div className="relative">
          <button
            onClick={handleCreateAccount}
            className="inline-block mt-8 bg-gradient-to-r from-pink-500 to-red-500 text-white font-bold py-4 px-12 rounded-full text-xl hover:from-pink-600 hover:to-red-600 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-pink-500/25 relative overflow-hidden group"
          >
